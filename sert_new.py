...
# ==== Настройки ====#
template_pdf = "сертификат_new_40.pdf"
output_name_pattern = "barcodes_Voron_100_{}.pdf"  # {} будет номер пачки
x_pos_mm = 220
y_pos_mm = 62

start_number = 40100000008157
end_number = 40100000008250
...
current_batch = 105   # Начальный номер пачки
counter = 0
writer = PdfWriter()
