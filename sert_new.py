...
# ==== Настройки ====#
template_pdf = "сертификат_MK_100_3012.pdf"
output_name_pattern = "barcodes_MK_100_{}.pdf"  # {} будет номер пачки
x_pos_mm = 220
y_pos_mm = 62

start_number = 10010000002287
end_number = 10010000002305
...
current_batch = 8   # Начальный номер пачки
counter = 0
writer = PdfWriter()
